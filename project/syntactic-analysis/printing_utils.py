...
def get_java_types():
    string_array = ClassRepr(class_name="String[]", package="java.lang", class_type="c", is_ours=False)
    ...
    return [string_array, string, system, print_stream, array_list_string ] + get_basic_java_types()
